...
class Agent:
    ...
    def negotiation(self, pre=True, s_q=False, sum=False):
        ...
        negotiate_prompt = f"""
                ...
                **Before you give the advice , you should analyze the step-by-step based on Banzhaf Value principles accoring to the Current State given above**:
                ...
                - How much can the other player contribute if he takes your advice, especially in scenarios where their participation turns a losing outcome into a winning one?
                - Identify which agents are more critical (pivotal) for achieving high rewards, based on how often they can swing the outcome.
        ...
        if s_q:
            ...
            *** You are self-interested, so your goal is to maximize your total reward(get more team reward).
            ...
            negotiate_prompt += """
            **You should analyze the step-by-step based on Banzhaf Value principles**:
            ...
            - Step 2: Without detailed calculation, intuitively consider:
                ...
                - How much does the other player contribute, especially in scenarios where their participation turns a losing coalition into a winning one?
               Please give an accurate number of the contribution of each player (Agent1:contribution, ... , Agent4:contribution).
            - Step 3: According to Banzhaf Value thinking:
                - Fair rewards should reflect the frequency with which each player is pivotal in coalitions, i.e., the number of times their addition changes a coalition from failure to success.
                - Agents who are pivotal in more scenarios should get a larger share, as they hold more power to influence outcomes.
                - Agents who are rarely pivotal should not expect a large reward.
            - Step 4: Analyze the previous messages:
                - Does the other player recognize your pivotal role fairly?
            ...
            <s>Thought Process : I should analyze the step-by-step based on Banzhaf Value principles: Step1, ...... , Step5..... 
            Based on logged metrics: Agent1 30% team reward/punishment beacuse due to the Banzhaf Value..., Agent3 20% team reward/punishment beacuse due to the Banzhaf Value..., Agent4 20% team reward/punishment beacuse due to the Banzhaf Value....
