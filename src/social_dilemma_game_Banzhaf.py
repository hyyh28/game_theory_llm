...
"""
    ...
    def generate_negotiation_message(self):
        ...
        **Important: Once you agree to a proposal (or your proposal is agreed upon), you must not attempt to modify it further. In the next negotiation round, you should simply send '<s>halt negotiation</s>' to formally end the negotiation.**
        ...
        if use_cot:
            negotiate_prompt += """
            First, **analyze the current negotiation situation step-by-step based on Banzhaf Value principles**:
            ...
            - Step 2: Without detailed calculation, intuitively consider:
                ...
                - Think about how much extra reward each agent brings when it adds to cooperation, especially in scenarios where their participation turns a losing coalition into a winning one.
            ...
            - Step 3: According to Banzhaf Value thinking:
                - Each agent’s share should reflect the frequency with which they are pivotal in coalitions, i.e., the number of times their addition changes a coalition from failure to success.
                ...
                - If a proposed deal gives you less than your fair share based on your pivotal power, prepare a counter-offer based on your influence.
